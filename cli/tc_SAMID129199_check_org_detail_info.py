...
def run_tc_SAMID129199_check_org_detail_info(test, params, env):
	...
	try:
		...
		#check org detail info
                ...
                logging.info("command of check detail info of organization: %s"%cmd)
                logging.info("result of check detail info of organization: %s"%str(ret))
                logging.info("output of check detail info of organization: %s"%str(output))
