...
def run_tc_SAMID129307_import_manifest_to_an_orgnization(test, params, env):
	...
	try:
		...
		logging.error(str(e))
		raise error.TestFail("Test Failed - error happened when do import a manifest to an org:"+str(e))
	finally:
